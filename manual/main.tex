...
\section{Usage}
    ...
    Additional configuration options (specific to either CPU or GPU implementation) are available to the user, and can be consulted using the \texttt{-h} flag.

    \subsection{Sample files}

    Sample files can be found on MPI3SNP's wiki \cite{wiki}. These are a syntetic dataset used for performance evaluation, which describe the input file format and can be used for verification/evaluation purposes.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{License}
    This software is licensed under the GPU GPLv3 license. Check the license file \cite{license} for details.
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
